...
const sharedVersion = '20260812-audio-face-guidance';
const adminScriptVersion = '20260812-face-attendance-guidance';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v173-face-attendance-guidance/);
