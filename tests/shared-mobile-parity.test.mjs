...
const sharedVersion = '20260813-dashboard-presence';
const adminScriptVersion = '20260813-dashboard-presence';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v177-dashboard-presence/);
