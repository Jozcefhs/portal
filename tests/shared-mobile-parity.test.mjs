...
const sharedVersion = '20260814-imprest-petty-cash';
const adminScriptVersion = '20260814-imprest-retirement-dialog-fix';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v181-imprest-retirement-dialog-fix/);
