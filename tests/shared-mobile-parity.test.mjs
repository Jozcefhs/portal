...
const sharedVersion = '20260816-attendance-name-size';
const adminScriptVersion = '20260816-clinic-face-verification';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v236-clinic-face-verification/);
