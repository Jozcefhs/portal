...
const sharedVersion = '20260727-desktop-header-tools';
const adminScriptVersion = '20260727-desktop-header-tools';
const pageNames = [
  'admin.html',
  'application.html',
  'buy-form.html',
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /digc-suite-v34-desktop-header-tools/);
