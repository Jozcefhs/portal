...
const sharedVersion = '20260727-mobile-charts-sidebar';
const adminScriptVersion = '20260727-mobile-charts-sidebar';
const pageNames = [
  'admin.html',
  'application.html',
  'buy-form.html',
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /digc-suite-v39-mobile-charts-sidebar/);
