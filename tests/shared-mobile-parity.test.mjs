...
const sharedVersion = '20260815-academic-readability';
const adminScriptVersion = '20260815-department-core-subjects';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v197-department-core-subjects/);
