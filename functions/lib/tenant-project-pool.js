...
export function publicTenantProjectSlot(slot = {}) {
  return {
    ...
    BillingAccountId: clean(slot.BillingAccountId),
    BillingVerifiedAt: clean(slot.BillingVerifiedAt),
...
export async function registerTenantProjectSlot(platformEnv, value = {}) {
  ...
  const slot = {
    ...
    BillingAccountId: clean(value.BillingAccountId || current?.BillingAccountId),
    BillingVerifiedAt: clean(value.BillingVerifiedAt || current?.BillingVerifiedAt),
