...
const sharedVersion = '20260815-shared-list-sorting';
const adminScriptVersion = '20260816-subject-teacher-corrections';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v217-subject-teacher-corrections/);
