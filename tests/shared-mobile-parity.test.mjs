...
const sharedVersion = '20260814-pos-camera-selection';
const adminScriptVersion = '20260814-records-desk-enrollment-camera';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v185-records-desk-enrollment-camera/);
