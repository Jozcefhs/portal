...
const sharedVersion = '20260801-batch-department-assignment';
const adminScriptVersion = '20260801-batch-department-assignment';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v75-batch-department-assignment/);
