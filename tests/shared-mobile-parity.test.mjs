...
const sharedVersion = '20260727-compact-checkout';
const adminScriptVersion = '20260727-compact-checkout';
const pageNames = [
  'admin.html',
  'application.html',
  'buy-form.html',
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /digc-suite-v40-compact-checkout/);
