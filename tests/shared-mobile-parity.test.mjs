...
const sharedVersion = '20260729-light-edit-icons';
const adminScriptVersion = '20260729-light-edit-icons';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v65-light-edit-icons/);
