...
const sharedVersion = '20260815-academic-management';
const adminScriptVersion = '20260815-teacher-responsibilities';
...
test('service worker refreshes the shared school, church, and parent assets', () => {
  assert.match(serviceWorker, /dynamax-v192-teacher-responsibilities/);
